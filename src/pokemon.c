...
// Assigns all Regional Dex Indexes to a National Dex Index
static const enum NationalDexOrder sRegionalToNationalOrder[REGIONAL_DEX_COUNT - 1] =
{
    REGIONAL_TO_NATIONAL(BULBASAUR),
    REGIONAL_TO_NATIONAL(IVYSAUR),
    REGIONAL_TO_NATIONAL(VENUSAUR),
    REGIONAL_TO_NATIONAL(CHARMANDER),
    REGIONAL_TO_NATIONAL(CHARMELEON),
    REGIONAL_TO_NATIONAL(CHARIZARD),
    REGIONAL_TO_NATIONAL(SQUIRTLE),
    REGIONAL_TO_NATIONAL(WARTORTLE),
    REGIONAL_TO_NATIONAL(BLASTOISE),
    REGIONAL_TO_NATIONAL(PIDGEY),
    REGIONAL_TO_NATIONAL(PIDGEOTTO),
    REGIONAL_TO_NATIONAL(PIDGEOT),
    REGIONAL_TO_NATIONAL(PICHU),
    REGIONAL_TO_NATIONAL(PIKACHU),
    REGIONAL_TO_NATIONAL(RAICHU),
    REGIONAL_TO_NATIONAL(NIDORAN_F),
    REGIONAL_TO_NATIONAL(NIDORINA),
    REGIONAL_TO_NATIONAL(NIDOQUEEN),
    REGIONAL_TO_NATIONAL(NIDORAN_M),
    REGIONAL_TO_NATIONAL(NIDORINO),
    REGIONAL_TO_NATIONAL(NIDOKING),
    REGIONAL_TO_NATIONAL(MEOWTH),
    REGIONAL_TO_NATIONAL(PERSIAN),
    REGIONAL_TO_NATIONAL(PERRSERKER),
    REGIONAL_TO_NATIONAL(MANKEY),
    REGIONAL_TO_NATIONAL(PRIMEAPE),
    REGIONAL_TO_NATIONAL(ANNIHILAPE),
    REGIONAL_TO_NATIONAL(POLIWAG),
    REGIONAL_TO_NATIONAL(POLIWHIRL),
    REGIONAL_TO_NATIONAL(POLIWRATH),
    REGIONAL_TO_NATIONAL(POLITOED),
    REGIONAL_TO_NATIONAL(SLOWPOKE),
    REGIONAL_TO_NATIONAL(SLOWBRO),
    REGIONAL_TO_NATIONAL(SLOWKING),
    REGIONAL_TO_NATIONAL(MAGNEMITE),
    REGIONAL_TO_NATIONAL(MAGNETON),
    REGIONAL_TO_NATIONAL(MAGNEZONE),
    REGIONAL_TO_NATIONAL(GASTLY),
    REGIONAL_TO_NATIONAL(HAUNTER),
    REGIONAL_TO_NATIONAL(GENGAR),
    REGIONAL_TO_NATIONAL(TYROGUE),
    REGIONAL_TO_NATIONAL(HITMONLEE),
    REGIONAL_TO_NATIONAL(HITMONCHAN),
    REGIONAL_TO_NATIONAL(HITMONTOP),
    REGIONAL_TO_NATIONAL(HORSEA),
    REGIONAL_TO_NATIONAL(SEADRA),
    REGIONAL_TO_NATIONAL(KINGDRA),
    REGIONAL_TO_NATIONAL(SCYTHER),
    REGIONAL_TO_NATIONAL(SCIZOR),
    REGIONAL_TO_NATIONAL(KLEAVOR),
    REGIONAL_TO_NATIONAL(MAGIKARP),
    REGIONAL_TO_NATIONAL(GYARADOS),
    REGIONAL_TO_NATIONAL(EEVEE),
    REGIONAL_TO_NATIONAL(VAPOREON),
    REGIONAL_TO_NATIONAL(JOLTEON),
    REGIONAL_TO_NATIONAL(FLAREON),
    REGIONAL_TO_NATIONAL(ESPEON),
    REGIONAL_TO_NATIONAL(UMBREON),
    REGIONAL_TO_NATIONAL(LEAFEON),
    REGIONAL_TO_NATIONAL(GLACEON),
    REGIONAL_TO_NATIONAL(SYLVEON),
    REGIONAL_TO_NATIONAL(AERODACTYL),
    REGIONAL_TO_NATIONAL(MUNCHLAX),
    REGIONAL_TO_NATIONAL(SNORLAX),
    REGIONAL_TO_NATIONAL(ELEKID),
    REGIONAL_TO_NATIONAL(ELECTABUZZ),
    REGIONAL_TO_NATIONAL(ELECTIVIRE),
    REGIONAL_TO_NATIONAL(MAGBY),
    REGIONAL_TO_NATIONAL(MAGMAR),
    REGIONAL_TO_NATIONAL(MAGMORTAR),
    REGIONAL_TO_NATIONAL(SMOOCHUM),
    REGIONAL_TO_NATIONAL(JYNX),
    REGIONAL_TO_NATIONAL(ARTICUNO),
    REGIONAL_TO_NATIONAL(ZAPDOS),
    REGIONAL_TO_NATIONAL(MOLTRES),
    REGIONAL_TO_NATIONAL(DRATINI),
    REGIONAL_TO_NATIONAL(DRAGONAIR),
    REGIONAL_TO_NATIONAL(DRAGONITE),
    REGIONAL_TO_NATIONAL(MEWTWO),
    REGIONAL_TO_NATIONAL(MEW),
    REGIONAL_TO_NATIONAL(CHIKORITA),
    REGIONAL_TO_NATIONAL(BAYLEEF),
    REGIONAL_TO_NATIONAL(MEGANIUM),
    REGIONAL_TO_NATIONAL(CYNDAQUIL),
    REGIONAL_TO_NATIONAL(QUILAVA),
    REGIONAL_TO_NATIONAL(TYPHLOSION),
    REGIONAL_TO_NATIONAL(TOTODILE),
    REGIONAL_TO_NATIONAL(CROCONAW),
    REGIONAL_TO_NATIONAL(FERALIGATR),
    REGIONAL_TO_NATIONAL(CHINCHOU),
    REGIONAL_TO_NATIONAL(LANTURN),
    REGIONAL_TO_NATIONAL(TOGEPI),
    REGIONAL_TO_NATIONAL(TOGETIC),
    REGIONAL_TO_NATIONAL(TOGEKISS),
    REGIONAL_TO_NATIONAL(AZURILL),
    REGIONAL_TO_NATIONAL(MARILL),
    REGIONAL_TO_NATIONAL(AZUMARILL),
    REGIONAL_TO_NATIONAL(BONSLY),
    REGIONAL_TO_NATIONAL(SUDOWOODO),
    REGIONAL_TO_NATIONAL(AIPOM),
    REGIONAL_TO_NATIONAL(AMBIPOM),
    REGIONAL_TO_NATIONAL(UNOWN),
    REGIONAL_TO_NATIONAL(GIRAFARIG),
    REGIONAL_TO_NATIONAL(FARIGIRAF),
    REGIONAL_TO_NATIONAL(DUNSPARCE),
    REGIONAL_TO_NATIONAL(DUDUNSPARCE),
    REGIONAL_TO_NATIONAL(GLIGAR),
    REGIONAL_TO_NATIONAL(GLISCOR),
    REGIONAL_TO_NATIONAL(SHUCKLE),
    REGIONAL_TO_NATIONAL(SNEASEL),
    REGIONAL_TO_NATIONAL(WEAVILE),
    REGIONAL_TO_NATIONAL(SNEASLER),
    REGIONAL_TO_NATIONAL(TEDDIURSA),
    REGIONAL_TO_NATIONAL(URSARING),
    REGIONAL_TO_NATIONAL(URSALUNA),
    REGIONAL_TO_NATIONAL(SWINUB),
    REGIONAL_TO_NATIONAL(PILOSWINE),
    REGIONAL_TO_NATIONAL(MAMOSWINE),
    REGIONAL_TO_NATIONAL(MANTYKE),
    REGIONAL_TO_NATIONAL(MANTINE),
    REGIONAL_TO_NATIONAL(SKARMORY),
    REGIONAL_TO_NATIONAL(STANTLER),
    REGIONAL_TO_NATIONAL(WYRDEER),
    REGIONAL_TO_NATIONAL(LARVITAR),
    REGIONAL_TO_NATIONAL(PUPITAR),
    REGIONAL_TO_NATIONAL(TYRANITAR),
    ...
    REGIONAL_TO_NATIONAL(TURTWIG),
    REGIONAL_TO_NATIONAL(GROTLE),
    REGIONAL_TO_NATIONAL(TORTERRA),
    REGIONAL_TO_NATIONAL(CHIMCHAR),
    REGIONAL_TO_NATIONAL(MONFERNO),
    REGIONAL_TO_NATIONAL(INFERNAPE),
    REGIONAL_TO_NATIONAL(PIPLUP),
    REGIONAL_TO_NATIONAL(PRINPLUP),
    REGIONAL_TO_NATIONAL(EMPOLEON),
    REGIONAL_TO_NATIONAL(STARLY),
    REGIONAL_TO_NATIONAL(STARAVIA),
    REGIONAL_TO_NATIONAL(STARAPTOR),
    REGIONAL_TO_NATIONAL(SHINX),
    REGIONAL_TO_NATIONAL(LUXIO),
    REGIONAL_TO_NATIONAL(LUXRAY),
    REGIONAL_TO_NATIONAL(BRONZOR),
    REGIONAL_TO_NATIONAL(BRONZONG),
    REGIONAL_TO_NATIONAL(GIBLE),
    REGIONAL_TO_NATIONAL(GABITE),
    REGIONAL_TO_NATIONAL(GARCHOMP),
    REGIONAL_TO_NATIONAL(RIOLU),
    REGIONAL_TO_NATIONAL(LUCARIO),
    REGIONAL_TO_NATIONAL(ROTOM),
    REGIONAL_TO_NATIONAL(CRESSELIA),
    REGIONAL_TO_NATIONAL(DARKRAI),
    REGIONAL_TO_NATIONAL(VICTINI),
    REGIONAL_TO_NATIONAL(SNIVY),
    REGIONAL_TO_NATIONAL(SERVINE),
    REGIONAL_TO_NATIONAL(SERPERIOR),
    REGIONAL_TO_NATIONAL(TEPIG),
    REGIONAL_TO_NATIONAL(PIGNITE),
    REGIONAL_TO_NATIONAL(EMBOAR),
    REGIONAL_TO_NATIONAL(OSHAWOTT),
    REGIONAL_TO_NATIONAL(DEWOTT),
    REGIONAL_TO_NATIONAL(SAMUROTT),
    REGIONAL_TO_NATIONAL(DRILBUR),
    REGIONAL_TO_NATIONAL(EXCADRILL),
    REGIONAL_TO_NATIONAL(PETILIL),
    REGIONAL_TO_NATIONAL(LILLIGANT),
    REGIONAL_TO_NATIONAL(COTTONEE),
    REGIONAL_TO_NATIONAL(WHIMSICOTT),
    REGIONAL_TO_NATIONAL(BASCULIN),
    REGIONAL_TO_NATIONAL(BASCULEGION),
    REGIONAL_TO_NATIONAL(SANDILE),
    REGIONAL_TO_NATIONAL(KROKOROK),
    REGIONAL_TO_NATIONAL(KROOKODILE),
    REGIONAL_TO_NATIONAL(ZORUA),
    REGIONAL_TO_NATIONAL(ZOROARK),
    REGIONAL_TO_NATIONAL(FERROSEED),
    REGIONAL_TO_NATIONAL(FERROTHORN),
    REGIONAL_TO_NATIONAL(GOLETT),
    REGIONAL_TO_NATIONAL(GOLURK),
    REGIONAL_TO_NATIONAL(PAWNIARD),
    REGIONAL_TO_NATIONAL(BISHARP),
    REGIONAL_TO_NATIONAL(KINGAMBIT),
    REGIONAL_TO_NATIONAL(DEINO),
    REGIONAL_TO_NATIONAL(ZWEILOUS),
    REGIONAL_TO_NATIONAL(HYDREIGON),
    REGIONAL_TO_NATIONAL(LARVESTA),
    REGIONAL_TO_NATIONAL(VOLCARONA),
    REGIONAL_TO_NATIONAL(TORNADUS),
    REGIONAL_TO_NATIONAL(THUNDURUS),
    REGIONAL_TO_NATIONAL(LANDORUS),
    REGIONAL_TO_NATIONAL(CHESPIN),
    REGIONAL_TO_NATIONAL(QUILLADIN),
    REGIONAL_TO_NATIONAL(CHESNAUGHT),
    REGIONAL_TO_NATIONAL(FENNEKIN),
    REGIONAL_TO_NATIONAL(BRAIXEN),
    REGIONAL_TO_NATIONAL(DELPHOX),
    REGIONAL_TO_NATIONAL(FROAKIE),
    REGIONAL_TO_NATIONAL(FROGADIER),
    REGIONAL_TO_NATIONAL(GRENINJA),
    REGIONAL_TO_NATIONAL(FLETCHLING),
    REGIONAL_TO_NATIONAL(FLETCHINDER),
    REGIONAL_TO_NATIONAL(TALONFLAME),
    REGIONAL_TO_NATIONAL(SKIDDO),
    REGIONAL_TO_NATIONAL(GOGOAT),
    REGIONAL_TO_NATIONAL(HONEDGE),
    REGIONAL_TO_NATIONAL(DOUBLADE),
    REGIONAL_TO_NATIONAL(AEGISLASH),
    REGIONAL_TO_NATIONAL(INKAY),
    REGIONAL_TO_NATIONAL(MALAMAR),
    REGIONAL_TO_NATIONAL(CLAUNCHER),
    REGIONAL_TO_NATIONAL(CLAWITZER),
    REGIONAL_TO_NATIONAL(TYRUNT),
    REGIONAL_TO_NATIONAL(TYRANTRUM),
    REGIONAL_TO_NATIONAL(HAWLUCHA),
    REGIONAL_TO_NATIONAL(GOOMY),
    REGIONAL_TO_NATIONAL(SLIGGOO),
    REGIONAL_TO_NATIONAL(GOODRA),
    REGIONAL_TO_NATIONAL(NOIBAT),
    REGIONAL_TO_NATIONAL(NOIVERN),
    REGIONAL_TO_NATIONAL(ROWLET),
    REGIONAL_TO_NATIONAL(DARTRIX),
    REGIONAL_TO_NATIONAL(DECIDUEYE),
    REGIONAL_TO_NATIONAL(LITTEN),
    REGIONAL_TO_NATIONAL(TORRACAT),
    REGIONAL_TO_NATIONAL(INCINEROAR),
    REGIONAL_TO_NATIONAL(POPPLIO),
    REGIONAL_TO_NATIONAL(BRIONNE),
    REGIONAL_TO_NATIONAL(PRIMARINA),
    REGIONAL_TO_NATIONAL(ROCKRUFF),
    REGIONAL_TO_NATIONAL(LYCANROC),
    REGIONAL_TO_NATIONAL(DEWPIDER),
    REGIONAL_TO_NATIONAL(ARAQUANID),
    REGIONAL_TO_NATIONAL(SALANDIT),
    REGIONAL_TO_NATIONAL(SALAZZLE),
    REGIONAL_TO_NATIONAL(SANDYGAST),
    REGIONAL_TO_NATIONAL(PALOSSAND),
    REGIONAL_TO_NATIONAL(MIMIKYU),
    REGIONAL_TO_NATIONAL(JANGMO_O),
    REGIONAL_TO_NATIONAL(HAKAMO_O),
    REGIONAL_TO_NATIONAL(KOMMO_O),
    REGIONAL_TO_NATIONAL(TAPU_KOKO),
    REGIONAL_TO_NATIONAL(TAPU_LELE),
    REGIONAL_TO_NATIONAL(TAPU_BULU),
    REGIONAL_TO_NATIONAL(TAPU_FINI),
    REGIONAL_TO_NATIONAL(COSMOG),
    REGIONAL_TO_NATIONAL(COSMOEM),
    REGIONAL_TO_NATIONAL(SOLGALEO),
    REGIONAL_TO_NATIONAL(LUNALA),
    REGIONAL_TO_NATIONAL(NIHILEGO),
    REGIONAL_TO_NATIONAL(BUZZWOLE),
    REGIONAL_TO_NATIONAL(PHEROMOSA),
    REGIONAL_TO_NATIONAL(XURKITREE),
    REGIONAL_TO_NATIONAL(CELESTEELA),
    REGIONAL_TO_NATIONAL(KARTANA),
    REGIONAL_TO_NATIONAL(GUZZLORD),
    REGIONAL_TO_NATIONAL(NECROZMA),
    REGIONAL_TO_NATIONAL(POIPOLE),
    REGIONAL_TO_NATIONAL(NAGANADEL),
    REGIONAL_TO_NATIONAL(STAKATAKA),
    REGIONAL_TO_NATIONAL(BLACEPHALON),
    REGIONAL_TO_NATIONAL(MELTAN),
    REGIONAL_TO_NATIONAL(MELMETAL),
    REGIONAL_TO_NATIONAL(GROOKEY),
    REGIONAL_TO_NATIONAL(THWACKEY),
    REGIONAL_TO_NATIONAL(RILLABOOM),
    REGIONAL_TO_NATIONAL(SCORBUNNY),
    REGIONAL_TO_NATIONAL(RABOOT),
    REGIONAL_TO_NATIONAL(CINDERACE),
    REGIONAL_TO_NATIONAL(SOBBLE),
    REGIONAL_TO_NATIONAL(DRIZZILE),
    REGIONAL_TO_NATIONAL(INTELEON),
    REGIONAL_TO_NATIONAL(ROOKIDEE),
    REGIONAL_TO_NATIONAL(CORVISQUIRE),
    REGIONAL_TO_NATIONAL(CORVIKNIGHT),
    REGIONAL_TO_NATIONAL(ARROKUDA),
    REGIONAL_TO_NATIONAL(BARRASKEWDA),
    REGIONAL_TO_NATIONAL(TOXEL),
    REGIONAL_TO_NATIONAL(TOXTRICITY),
    REGIONAL_TO_NATIONAL(HATENNA),
    REGIONAL_TO_NATIONAL(HATTREM),
    REGIONAL_TO_NATIONAL(HATTERENE),
    REGIONAL_TO_NATIONAL(IMPIDIMP),
    REGIONAL_TO_NATIONAL(MORGREM),
    REGIONAL_TO_NATIONAL(GRIMMSNARL),
    REGIONAL_TO_NATIONAL(INDEEDEE),
    REGIONAL_TO_NATIONAL(DRACOZOLT),
    REGIONAL_TO_NATIONAL(ARCTOZOLT),
    REGIONAL_TO_NATIONAL(DRACOVISH),
    REGIONAL_TO_NATIONAL(ARCTOVISH),
    REGIONAL_TO_NATIONAL(DURALUDON),
    REGIONAL_TO_NATIONAL(ARCHALUDON),
    REGIONAL_TO_NATIONAL(DREEPY),
    REGIONAL_TO_NATIONAL(DRAKLOAK),
    REGIONAL_TO_NATIONAL(DRAGAPULT),
    REGIONAL_TO_NATIONAL(KUBFU),
    REGIONAL_TO_NATIONAL(URSHIFU),
    REGIONAL_TO_NATIONAL(ENAMORUS),
    REGIONAL_TO_NATIONAL(SPRIGATITO),
    REGIONAL_TO_NATIONAL(FLORAGATO),
    REGIONAL_TO_NATIONAL(MEOWSCARADA),
    REGIONAL_TO_NATIONAL(FUECOCO),
    REGIONAL_TO_NATIONAL(CROCALOR),
    REGIONAL_TO_NATIONAL(SKELEDIRGE),
    REGIONAL_TO_NATIONAL(QUAXLY),
    REGIONAL_TO_NATIONAL(QUAXWELL),
    REGIONAL_TO_NATIONAL(QUAQUAVAL),
    REGIONAL_TO_NATIONAL(NYMBLE),
    REGIONAL_TO_NATIONAL(LOKIX),
    REGIONAL_TO_NATIONAL(CHARCADET),
    REGIONAL_TO_NATIONAL(ARMAROUGE),
    REGIONAL_TO_NATIONAL(CERULEDGE),
    REGIONAL_TO_NATIONAL(TADBULB),
    REGIONAL_TO_NATIONAL(BELLIBOLT),
    REGIONAL_TO_NATIONAL(FINIZEN),
    REGIONAL_TO_NATIONAL(PALAFIN),
    REGIONAL_TO_NATIONAL(GREAVARD),
    REGIONAL_TO_NATIONAL(HOUNDSTONE),
    REGIONAL_TO_NATIONAL(DONDOZO),
    REGIONAL_TO_NATIONAL(TATSUGIRI),
    REGIONAL_TO_NATIONAL(GREAT_TUSK),
    REGIONAL_TO_NATIONAL(SCREAM_TAIL),
    REGIONAL_TO_NATIONAL(BRUTE_BONNET),
    REGIONAL_TO_NATIONAL(FLUTTER_MANE),
    REGIONAL_TO_NATIONAL(SLITHER_WING),
    REGIONAL_TO_NATIONAL(SANDY_SHOCKS),
    REGIONAL_TO_NATIONAL(IRON_TREADS),
    REGIONAL_TO_NATIONAL(IRON_BUNDLE),
    REGIONAL_TO_NATIONAL(IRON_HANDS),
    REGIONAL_TO_NATIONAL(IRON_JUGULIS),
    REGIONAL_TO_NATIONAL(IRON_MOTH),
    REGIONAL_TO_NATIONAL(IRON_THORNS),
    REGIONAL_TO_NATIONAL(FRIGIBAX),
    REGIONAL_TO_NATIONAL(ARCTIBAX),
    REGIONAL_TO_NATIONAL(BAXCALIBUR),
    REGIONAL_TO_NATIONAL(GIMMIGHOUL),
    REGIONAL_TO_NATIONAL(GHOLDENGO),
    REGIONAL_TO_NATIONAL(WO_CHIEN),
    REGIONAL_TO_NATIONAL(CHIEN_PAO),
    REGIONAL_TO_NATIONAL(TING_LU),
    REGIONAL_TO_NATIONAL(CHI_YU),
    REGIONAL_TO_NATIONAL(ROARING_MOON),
    REGIONAL_TO_NATIONAL(IRON_VALIANT),
    REGIONAL_TO_NATIONAL(WALKING_WAKE),
    REGIONAL_TO_NATIONAL(IRON_LEAVES),
    REGIONAL_TO_NATIONAL(OGERPON),
    REGIONAL_TO_NATIONAL(GOUGING_FIRE),
    REGIONAL_TO_NATIONAL(RAGING_BOLT),
    REGIONAL_TO_NATIONAL(IRON_BOULDER),
    REGIONAL_TO_NATIONAL(IRON_CROWN),
    REGIONAL_TO_NATIONAL(ZOJZION),
    REGIONAL_TO_NATIONAL(MANTISTRIKE),
    REGIONAL_TO_NATIONAL(PYROLIN),
    REGIONAL_TO_NATIONAL(STRATOSPIRA),
    REGIONAL_TO_NATIONAL(PHANTOMAR),
    REGIONAL_TO_NATIONAL(LEVIADON),
    REGIONAL_TO_NATIONAL(AMANISTE),
};
...
void CreateBoxMon(struct BoxPokemon *boxMon, u16 species, u8 level, u8 fixedIV, u8 hasFixedPersonality, u32 fixedPersonality, u8 otIdType, u32 fixedOtId)
{
    ...
    if (otIdType >= OT_ID_JAKE)
    {
        value = gOTStruct[otIdType].id;
        StringCopy_PlayerName(gStringVar1, gOTStruct[otIdType].name);
        gender = gOTStruct[otIdType].gender;
    }
    else
    {
    ...
    SetBoxMonData(boxMon, MON_DATA_OT_NAME, gStringVar1);
