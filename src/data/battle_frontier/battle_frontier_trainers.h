...
const struct BattleFrontierTrainer gBattleFrontierTrainers[FRONTIER_TRAINERS_COUNT] =
{
    ...
    [FRONTIER_TRAINER_CLAYTON] =
    {
        ...
        .speechWin = COMPOUND_STRING("Where is it? I've lost my pokenav."),
    ...
    [FRONTIER_TRAINER_ABBIE] =
    {
        .facilityClass = FACILITY_CLASS_AROMA_LADY,
        .trainerName = _("ABBIE"),
        .speechBefore = COMPOUND_STRING("You try my secret aromatherapy ok?"),
    ...
    [FRONTIER_TRAINER_MARLON] =
    {
        ...
        .speechWin = COMPOUND_STRING("A little radio huh? That's totally cool."),
