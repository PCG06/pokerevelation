...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    [SLATEPORT_TENT_TRAINER_JOLIE] = {
        ...
        .trainerName = _("JOLIE"),
        .speechBefore = COMPOUND_STRING("What will I be tomorrow?"),
        .speechWin = COMPOUND_STRING("I am feeling like it's friday!"),
        .speechLose = COMPOUND_STRING("I am feeling like it's monday…"),
        .monSet = gSlateportBattleTentTrainerMons_Jolie
    },
    [SLATEPORT_TENT_TRAINER_MALACHI] = {
        .facilityClass = FACILITY_CLASS_RUIN_MANIAC,
        .trainerName = _("MALACHI"),
        .speechBefore = COMPOUND_STRING("Bad news! It's a sand tomb."),
        .speechWin = COMPOUND_STRING("Yeehaw excl -1 -1 I've done it."),
        .speechLose = COMPOUND_STRING("I've lost in this sand tomb…"),
    ...
    [SLATEPORT_TENT_TRAINER_KELSIE] = {
        ...
        .speechBefore = COMPOUND_STRING("Go!! My bath Pokémon!!"),
        .speechWin = COMPOUND_STRING("Yahoo!! My bath Pokémon!!"),
        .speechLose = COMPOUND_STRING("Gwah!! My bath Pokémon!!"),
        .monSet = gSlateportBattleTentTrainerMons_Kelsie
    },
    [SLATEPORT_TENT_TRAINER_DAVON] = {
        .facilityClass = FACILITY_CLASS_TUBER_M,
        .trainerName = _("DAVON"),
        .speechBefore = COMPOUND_STRING("Yeah yeah!! -1 great whirlpool isn't it ques."),
        .speechWin = COMPOUND_STRING("That was like a whirlpool yeah yeah!!"),
        .speechLose = COMPOUND_STRING("Don't get beat up in that whirlpool."),
        .monSet = gSlateportBattleTentTrainerMons_Davon
    },
    [SLATEPORT_TENT_TRAINER_GLENDA] = {
        .facilityClass = FACILITY_CLASS_LADY,
        .trainerName = _("GLENDA"),
        .speechBefore = COMPOUND_STRING("Conversation can wait until I win."),
        .speechWin = COMPOUND_STRING("Fabulous! I am going to rock."),
        .speechLose = COMPOUND_STRING("No! -1 I wasn't serious."),
        .monSet = gSlateportBattleTentTrainerMons_Glenda
    },
    [SLATEPORT_TENT_TRAINER_HELENA] = {
        .facilityClass = FACILITY_CLASS_BEAUTY,
        .trainerName = _("HELENA"),
        .speechBefore = COMPOUND_STRING("Does my beauty intimidate you?"),
        .speechWin = COMPOUND_STRING("I am so sorry but you're boring."),
        .speechLose = COMPOUND_STRING("I do so enjoy this!"),
        .monSet = gSlateportBattleTentTrainerMons_Helena
    },
    [SLATEPORT_TENT_TRAINER_RODOLFO] = {
        .facilityClass = FACILITY_CLASS_RICH_BOY,
        .trainerName = _("RODOLFO"),
        .speechBefore = COMPOUND_STRING("Go get a Whiscash for me."),
        .speechWin = COMPOUND_STRING("Aww you don't have a Whiscash."),
        .speechLose = COMPOUND_STRING("Please I need a Whiscash badly."),
    ...
    [SLATEPORT_TENT_TRAINER_DAVION] = {
        ...
        .speechBefore = COMPOUND_STRING("Graaah graaah!! Graaah graaah!!"),
        .speechWin = COMPOUND_STRING("Roar! -1 roar!! -1."),
        .speechLose = COMPOUND_STRING("Urgh waaah!! -1 -1 -1."),
    ...
    [SLATEPORT_TENT_TRAINER_KENDALL] = {
        ...
        .speechBefore = COMPOUND_STRING("A little petal dance to please you!"),
        .speechWin = COMPOUND_STRING("I do this only for work."),
        .speechLose = COMPOUND_STRING("How could you pound me?"),
        .monSet = gSlateportBattleTentTrainerMons_Kendall
    },
    [SLATEPORT_TENT_TRAINER_COLTEN] = {
        .facilityClass = FACILITY_CLASS_CAMPER,
        .trainerName = _("COLTEN"),
        .speechBefore = COMPOUND_STRING("I want to go run around."),
        .speechWin = COMPOUND_STRING("Yay! Want to run?"),
        .speechLose = COMPOUND_STRING("A swift swim would be good too."),
        .monSet = gSlateportBattleTentTrainerMons_Colten
    },
    [SLATEPORT_TENT_TRAINER_IRVIN] = {
        .facilityClass = FACILITY_CLASS_BUG_MANIAC,
        .trainerName = _("IRVIN"),
        .speechBefore = COMPOUND_STRING("Have a look at my confuse ray."),
        .speechWin = COMPOUND_STRING("Yahoo my confuse ray is the best."),
        .speechLose = COMPOUND_STRING("Gwah!! -1 I am sorry!"),
        .monSet = gSlateportBattleTentTrainerMons_Irvin
    },
    [SLATEPORT_TENT_TRAINER_SHAUN] = {
        .facilityClass = FACILITY_CLASS_GENTLEMAN,
        .trainerName = _("SHAUN"),
        .speechBefore = COMPOUND_STRING("Listen… You aren't very good."),
        .speechWin = COMPOUND_STRING("You see? I was right."),
        .speechLose = COMPOUND_STRING("Yes yes… You're quite something."),
    ...
    [SLATEPORT_TENT_TRAINER_KYLER] = {
        ...
        .speechWin = COMPOUND_STRING("……………………………………… Yay."),
        .speechLose = COMPOUND_STRING("……………………………………… Wow."),
        .monSet = gSlateportBattleTentTrainerMons_Kyler
    },
    [SLATEPORT_TENT_TRAINER_MAGGIE] = {
        .facilityClass = FACILITY_CLASS_SCHOOL_KID_F,
        .trainerName = _("MAGGIE"),
        .speechBefore = COMPOUND_STRING("Vulpix Xatu Umbreon… Um…"),
        .speechWin = COMPOUND_STRING("Nosepass… Um Seviper! -1."),
        .speechLose = COMPOUND_STRING("Nosepass… Um Snorlax… Uh-oh."),
        .monSet = gSlateportBattleTentTrainerMons_Maggie
    },
    [SLATEPORT_TENT_TRAINER_STEPHON] = {
        .facilityClass = FACILITY_CLASS_COOLTRAINER_M,
        .trainerName = _("STEPHON"),
        .speechBefore = COMPOUND_STRING("I am going to enjoy an egg."),
        .speechWin = COMPOUND_STRING("I will enjoy this tasty victory."),
        .speechLose = COMPOUND_STRING("Awful!! -1 just awful!!"),
        .monSet = gSlateportBattleTentTrainerMons_Stephon
    },
    [SLATEPORT_TENT_TRAINER_REBECCA] = {
        .facilityClass = FACILITY_CLASS_COOLTRAINER_F,
        .trainerName = _("REBECCA"),
        .speechBefore = COMPOUND_STRING("That egg has a tasty shine."),
        .speechWin = COMPOUND_STRING("I can't! Smell that stench."),
        .speechLose = COMPOUND_STRING("You can't make me stop…"),
        .monSet = gSlateportBattleTentTrainerMons_Rebecca
    },
    [SLATEPORT_TENT_TRAINER_REGGIE] = {
        .facilityClass = FACILITY_CLASS_POKEFAN_M,
        .trainerName = _("REGGIE"),
        .speechBefore = COMPOUND_STRING("Pokémon come before money or family."),
        .speechWin = COMPOUND_STRING("That's what is making me strong."),
        .speechLose = COMPOUND_STRING("That's why I am so thick…"),
        .monSet = gSlateportBattleTentTrainerMons_Reggie
    },
    [SLATEPORT_TENT_TRAINER_JANAE] = {
        .facilityClass = FACILITY_CLASS_POKEFAN_F,
        .trainerName = _("JANAE"),
        .speechBefore = COMPOUND_STRING("I just adore your tough look."),
        .speechWin = COMPOUND_STRING("I like how you struggle -1."),
        .speechLose = COMPOUND_STRING("You're a mean and awful trainer."),
    ...
    [SLATEPORT_TENT_TRAINER_CAIDEN] = {
        ...
        .speechBefore = COMPOUND_STRING("My curse will break your spirit."),
        .speechWin = COMPOUND_STRING("Curse? It's a lie…"),
        .speechLose = COMPOUND_STRING("My curse will last forever -1."),
    ...
    [SLATEPORT_TENT_TRAINER_KIRSTEN] = {
        ...
        .speechBefore = COMPOUND_STRING("Huh ques a battle you said?"),
        .speechWin = COMPOUND_STRING("Huh ques strong but not strong enough."),
        .speechLose = COMPOUND_STRING("Huh ques I surrender to your strength."),
        .monSet = gSlateportBattleTentTrainerMons_Kirsten
    },
    [SLATEPORT_TENT_TRAINER_KURTIS] = {
        .facilityClass = FACILITY_CLASS_YOUNGSTER,
        .trainerName = _("KURTIS"),
        .speechBefore = COMPOUND_STRING("Sorry you're going to get beat up."),
        .speechWin = COMPOUND_STRING("I said we would pound you."),
        .speechLose = COMPOUND_STRING("How did I get beat up?"),
        .monSet = gSlateportBattleTentTrainerMons_Kurtis
    },
    [SLATEPORT_TENT_TRAINER_STEFAN] = {
        .facilityClass = FACILITY_CLASS_FISHERMAN,
        .trainerName = _("STEFAN"),
        .speechBefore = COMPOUND_STRING("I only want cute Pokémon -1."),
        .speechWin = COMPOUND_STRING("What is it to you?"),
        .speechLose = COMPOUND_STRING("You're kind of awesome… -1."),
        .monSet = gSlateportBattleTentTrainerMons_Stefan
    },
    [SLATEPORT_TENT_TRAINER_AVERY] = {
        .facilityClass = FACILITY_CLASS_BIRD_KEEPER,
        .trainerName = _("AVERY"),
        .speechBefore = COMPOUND_STRING("Toys! I need more toys."),
        .speechWin = COMPOUND_STRING("I need some easy money fast."),
        .speechLose = COMPOUND_STRING("I need to work for money."),
        .monSet = gSlateportBattleTentTrainerMons_Avery
    },
    [SLATEPORT_TENT_TRAINER_DWANE] = {
        .facilityClass = FACILITY_CLASS_NINJA_BOY,
        .trainerName = _("DWANE"),
        .speechBefore = COMPOUND_STRING("Mmm tasty… Wonder what?"),
        .speechWin = COMPOUND_STRING("Mmm mmm… You don't know."),
        .speechLose = COMPOUND_STRING("Mmm mmm… Oh, yeah this is it excl -1."),
        .monSet = gSlateportBattleTentTrainerMons_Dwane
    },
    [SLATEPORT_TENT_TRAINER_MCKENNA] = {
        .facilityClass = FACILITY_CLASS_PARASOL_LADY,
        .trainerName = _("MCKENNA"),
        .speechBefore = COMPOUND_STRING("I dislike small talk let's go."),
        .speechWin = COMPOUND_STRING("Yup that's that -1 -1 -1."),
        .speechLose = COMPOUND_STRING("Kthx bye -1 -1 -1 -1 -1."),
    ...
    [SLATEPORT_TENT_TRAINER_CAMRYN] = {
        ...
        .speechBefore = COMPOUND_STRING("Mr judge you have our trust."),
        .speechWin = COMPOUND_STRING("Yes sir excl we're no 1 in this contest."),
        .speechLose = COMPOUND_STRING("I won't give up my idol dream."),
    ...
    [SLATEPORT_TENT_TRAINER_NATASHA] = {
        ...
        .speechBefore = COMPOUND_STRING("Come over to my place ok ques -1."),
        .speechWin = COMPOUND_STRING("Come on over it will be great."),
        .speechLose = COMPOUND_STRING("Aww won't you come over? -1."),
        .monSet = gSlateportBattleTentTrainerMons_Natasha
    },
    [SLATEPORT_TENT_TRAINER_AUSTYN] = {
        .facilityClass = FACILITY_CLASS_SAILOR,
        .trainerName = _("AUSTYN"),
        .speechBefore = COMPOUND_STRING("I don't care how we match up."),
        .speechWin = COMPOUND_STRING("Hah back to school for you."),
        .speechLose = COMPOUND_STRING("I need to study my lessons."),
    ...
    [SLATEPORT_TENT_TRAINER_DONOVAN] = {
        ...
        .speechBefore = COMPOUND_STRING("Oh I am feeling slimy all over."),
        .speechWin = COMPOUND_STRING("You're going down the mega drain hahaha."),
        .speechLose = COMPOUND_STRING("I am naturally slimy that's what I am."),
        .monSet = gSlateportBattleTentTrainerMons_Donovan
    },
    [SLATEPORT_TENT_TRAINER_TAMIA] = {
        .facilityClass = FACILITY_CLASS_LASS,
        .trainerName = _("TAMIA"),
        .speechBefore = COMPOUND_STRING("I am angry with my father…"),
        .speechWin = COMPOUND_STRING("I really dislike my father!"),
        .speechLose = COMPOUND_STRING("I just so adore my father."),
...
const struct BattleFrontierTrainer gVerdanturfBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    [VERDANTURF_TENT_TRAINER_BRENNA] = {
        ...
        .speechBefore = COMPOUND_STRING("No days go without my fake tears."),
        .speechWin = COMPOUND_STRING("Oh that was so refreshing! -1."),
        .speechLose = COMPOUND_STRING("All I ever get is torment."),
        .monSet = gVerdanturfBattleTentTrainerMons_Brenna
    },
    [VERDANTURF_TENT_TRAINER_DILAN] = {
        .facilityClass = FACILITY_CLASS_RUIN_MANIAC,
        .trainerName = _("DILAN"),
        .speechBefore = COMPOUND_STRING("You don't know how bored I am."),
        .speechWin = COMPOUND_STRING("Losing isn't exciting at all…"),
        .speechLose = COMPOUND_STRING("Exciting!! Bye bye to being bored."),
        .monSet = gVerdanturfBattleTentTrainerMons_Dilan
    },
    [VERDANTURF_TENT_TRAINER_ELIANA] = {
        .facilityClass = FACILITY_CLASS_TUBER_F,
        .trainerName = _("ELIANA"),
        .speechBefore = COMPOUND_STRING("I am going on a vacation soon."),
        .speechWin = COMPOUND_STRING("I need to get some money."),
        .speechLose = COMPOUND_STRING("No sleep until I get home."),
        .monSet = gVerdanturfBattleTentTrainerMons_Eliana
    },
    [VERDANTURF_TENT_TRAINER_MARKUS] = {
        .facilityClass = FACILITY_CLASS_TUBER_M,
        .trainerName = _("MARKUS"),
        .speechBefore = COMPOUND_STRING("I am smart! If I lose I self destruct."),
        .speechWin = COMPOUND_STRING("It's a non stop explosion of joy."),
        .speechLose = COMPOUND_STRING("I've lost… Time to self destruct."),
        .monSet = gVerdanturfBattleTentTrainerMons_Markus
    },
    [VERDANTURF_TENT_TRAINER_CAITLYN] = {
        .facilityClass = FACILITY_CLASS_LADY,
        .trainerName = _("CAITLYN"),
        .speechBefore = COMPOUND_STRING("I am bored of being an idol."),
        .speechWin = COMPOUND_STRING("A battle is best for happiness."),
        .speechLose = COMPOUND_STRING("Losing doesn't bug me at all."),
        .monSet = gVerdanturfBattleTentTrainerMons_Caitlyn
    },
    [VERDANTURF_TENT_TRAINER_DESIREE] = {
        .facilityClass = FACILITY_CLASS_BEAUTY,
        .trainerName = _("DESIREE"),
        .speechBefore = COMPOUND_STRING("Doesn't my beauty astonish you?"),
        .speechWin = COMPOUND_STRING("Did I intimidate you? -1."),
        .speechLose = COMPOUND_STRING("My beauty did nothing for you."),
        .monSet = gVerdanturfBattleTentTrainerMons_Desiree
    },
    [VERDANTURF_TENT_TRAINER_RONALD] = {
        .facilityClass = FACILITY_CLASS_RICH_BOY,
        .trainerName = _("RONALD"),
        .speechBefore = COMPOUND_STRING("Come on I will battle seriously -1."),
        .speechWin = COMPOUND_STRING("Give up? -1 that's really weak."),
        .speechLose = COMPOUND_STRING("I need to do a baton pass."),
        .monSet = gVerdanturfBattleTentTrainerMons_Ronald
    },
    [VERDANTURF_TENT_TRAINER_ASHTEN] = {
        .facilityClass = FACILITY_CLASS_POKEMANIAC,
        .trainerName = _("ASHTEN"),
        .speechBefore = COMPOUND_STRING("Oh, yeah another exciting battle! -1."),
        .speechWin = COMPOUND_STRING("Your Pokémon are wimpy and boring."),
        .speechLose = COMPOUND_STRING("That was an exciting loss wow!"),
        .monSet = gVerdanturfBattleTentTrainerMons_Ashten
    },
    [VERDANTURF_TENT_TRAINER_GERARD] = {
        .facilityClass = FACILITY_CLASS_SWIMMER_M,
        .trainerName = _("GERARD"),
        .speechBefore = COMPOUND_STRING("Look at my super teeter dance!"),
        .speechWin = COMPOUND_STRING("That was hard… Am I ok ques."),
        .speechLose = COMPOUND_STRING("I won't forgive you for that."),
        .monSet = gVerdanturfBattleTentTrainerMons_Gerard
    },
    [VERDANTURF_TENT_TRAINER_BRADLY] = {
        .facilityClass = FACILITY_CLASS_CAMPER,
        .trainerName = _("BRADLY"),
        .speechBefore = COMPOUND_STRING("It's lonesome but I vacation alone."),
        .speechWin = COMPOUND_STRING("I will withdraw inside my shell armor."),
        .speechLose = COMPOUND_STRING("Oh… -1 alone as always."),
        .monSet = gVerdanturfBattleTentTrainerMons_Bradly
    },
    [VERDANTURF_TENT_TRAINER_DENNIS] = {
        .facilityClass = FACILITY_CLASS_BUG_MANIAC,
        .trainerName = _("DENNIS"),
        .speechBefore = COMPOUND_STRING("Are you really strong? -1."),
        .speechWin = COMPOUND_STRING("Wahahaha! -1 wahahaha!! -1."),
        .speechLose = COMPOUND_STRING("Nice going! I was child's play."),
        .monSet = gVerdanturfBattleTentTrainerMons_Dennis
    },
    [VERDANTURF_TENT_TRAINER_PRESTIN] = {
        .facilityClass = FACILITY_CLASS_GENTLEMAN,
        .trainerName = _("PRESTIN"),
        .speechBefore = COMPOUND_STRING("This is a nightmare for you."),
        .speechWin = COMPOUND_STRING("Forgive me… It's a dream."),
        .speechLose = COMPOUND_STRING("I want to wake up from this."),
        .monSet = gVerdanturfBattleTentTrainerMons_Prestin
    },
    [VERDANTURF_TENT_TRAINER_ERNESTO] = {
        .facilityClass = FACILITY_CLASS_GUITARIST,
        .trainerName = _("ERNESTO"),
        .speechBefore = COMPOUND_STRING("This party goes on forever!"),
        .speechWin = COMPOUND_STRING("The music plays on without end."),
        .speechLose = COMPOUND_STRING("No! The music can't stop."),
        .monSet = gVerdanturfBattleTentTrainerMons_Ernesto
    },
    [VERDANTURF_TENT_TRAINER_NALA] = {
        .facilityClass = FACILITY_CLASS_SCHOOL_KID_F,
        .trainerName = _("NALA"),
        .speechBefore = COMPOUND_STRING("I want the world movie collection."),
        .speechWin = COMPOUND_STRING("I don't like radio very much."),
        .speechLose = COMPOUND_STRING("I refuse to believe this!"),
        .monSet = gVerdanturfBattleTentTrainerMons_Nala
    },
    [VERDANTURF_TENT_TRAINER_DARNELL] = {
        .facilityClass = FACILITY_CLASS_COOLTRAINER_M,
        .trainerName = _("DARNELL"),
        .speechBefore = COMPOUND_STRING("I will go easy on you -1."),
        .speechWin = COMPOUND_STRING("Your frustration should be hidden away."),
        .speechLose = COMPOUND_STRING("You're too much to take…"),
        .monSet = gVerdanturfBattleTentTrainerMons_Darnell
    },
    [VERDANTURF_TENT_TRAINER_ASHLYN] = {
        .facilityClass = FACILITY_CLASS_COOLTRAINER_F,
        .trainerName = _("ASHLYN"),
        .speechBefore = COMPOUND_STRING("I look tough do I?"),
        .speechWin = COMPOUND_STRING("I am not over your taunt yet."),
        .speechLose = COMPOUND_STRING("You're mean!! -1 -1 -1."),
        .monSet = gVerdanturfBattleTentTrainerMons_Ashlyn
    },
    [VERDANTURF_TENT_TRAINER_ADDISON] = {
        .facilityClass = FACILITY_CLASS_POKEFAN_M,
        .trainerName = _("ADDISON"),
        .speechBefore = COMPOUND_STRING("Yes! -1 my Pokémon!"),
        .speechWin = COMPOUND_STRING("Well wasn't that easy? -1."),
        .speechLose = COMPOUND_STRING("Waaah! -1 but why?"),
        .monSet = gVerdanturfBattleTentTrainerMons_Addison
    },
    [VERDANTURF_TENT_TRAINER_JUSTINE] = {
        .facilityClass = FACILITY_CLASS_POKEFAN_F,
        .trainerName = _("JUSTINE"),
        .speechBefore = COMPOUND_STRING("Yes! -1 come on I am ready."),
        .speechWin = COMPOUND_STRING("You're just not good enough!"),
        .speechLose = COMPOUND_STRING("Wowee!! -1 -1 -1 -1."),
        .monSet = gVerdanturfBattleTentTrainerMons_Justine
    },
    [VERDANTURF_TENT_TRAINER_TYSON] = {
        .facilityClass = FACILITY_CLASS_EXPERT_M,
        .trainerName = _("TYSON"),
        .speechBefore = COMPOUND_STRING("You're going to pressure me?"),
        .speechWin = COMPOUND_STRING("What? You're much too weak!"),
        .speechLose = COMPOUND_STRING("This doesn't make me happy!"),
        .monSet = gVerdanturfBattleTentTrainerMons_Tyson
    },
    [VERDANTURF_TENT_TRAINER_LAILA] = {
        .facilityClass = FACILITY_CLASS_EXPERT_F,
        .trainerName = _("LAILA"),
        .speechBefore = COMPOUND_STRING("A struggle isn't very cool -1."),
        .speechWin = COMPOUND_STRING("Nope not very cool at all!"),
        .speechLose = COMPOUND_STRING("You're not cool but you won."),
        .monSet = gVerdanturfBattleTentTrainerMons_Laila
    },
    [VERDANTURF_TENT_TRAINER_WAREN] = {
        .facilityClass = FACILITY_CLASS_YOUNGSTER,
        .trainerName = _("WAREN"),
        .speechBefore = COMPOUND_STRING("Danger! -1 I sense danger."),
        .speechWin = COMPOUND_STRING("Did you believe my lie?!"),
        .speechLose = COMPOUND_STRING("I really did sense danger…"),
        .monSet = gVerdanturfBattleTentTrainerMons_Waren
    },
    [VERDANTURF_TENT_TRAINER_TOBIAS] = {
        .facilityClass = FACILITY_CLASS_FISHERMAN,
        .trainerName = _("TOBIAS"),
        .speechBefore = COMPOUND_STRING("Barrier!! -1 now come on!"),
        .speechWin = COMPOUND_STRING("Huh ques you mean I won?"),
        .speechLose = COMPOUND_STRING("I should know that it's hopeless."),
        .monSet = gVerdanturfBattleTentTrainerMons_Tobias
    },
    [VERDANTURF_TENT_TRAINER_JOSIAH] = {
        .facilityClass = FACILITY_CLASS_BIRD_KEEPER,
        .trainerName = _("JOSIAH"),
        .speechBefore = COMPOUND_STRING("I promise to fly if I lose -1."),
        .speechWin = COMPOUND_STRING("Too weak… -1 you fly instead."),
        .speechLose = COMPOUND_STRING("I promise to fly sometime soon."),
        .monSet = gVerdanturfBattleTentTrainerMons_Josiah
    },
    [VERDANTURF_TENT_TRAINER_DION] = {
        .facilityClass = FACILITY_CLASS_NINJA_BOY,
        .trainerName = _("DION"),
        .speechBefore = COMPOUND_STRING("It's trendy um battle something -1."),
        .speechWin = COMPOUND_STRING("Was it… Battle date?"),
        .speechLose = COMPOUND_STRING("Was it… Battle gourmet?"),
        .monSet = gVerdanturfBattleTentTrainerMons_Dion
    },
    [VERDANTURF_TENT_TRAINER_KENZIE] = {
        .facilityClass = FACILITY_CLASS_PARASOL_LADY,
        .trainerName = _("KENZIE"),
        .speechBefore = COMPOUND_STRING("The morning sun gives me strength -1."),
        .speechWin = COMPOUND_STRING("But I like moonlight too -1."),
        .speechLose = COMPOUND_STRING("You're like a terrible sandstorm…"),
        .monSet = gVerdanturfBattleTentTrainerMons_Kenzie
    },
    [VERDANTURF_TENT_TRAINER_LILLIAN] = {
        .facilityClass = FACILITY_CLASS_SWIMMER_F,
        .trainerName = _("LILLIAN"),
        .speechBefore = COMPOUND_STRING("I do things at my own tempo."),
        .speechWin = COMPOUND_STRING("I won? What a surprise."),
        .speechLose = COMPOUND_STRING("Aww… I need a nap."),
        .monSet = gVerdanturfBattleTentTrainerMons_Lillian
    },
    [VERDANTURF_TENT_TRAINER_LESLEY] = {
        .facilityClass = FACILITY_CLASS_PICNICKER,
        .trainerName = _("LESLEY"),
        .speechBefore = COMPOUND_STRING("You should not be lolling about."),
        .speechWin = COMPOUND_STRING("You should get up earlier -1."),
        .speechLose = COMPOUND_STRING("This should not be happening!"),
        .monSet = gVerdanturfBattleTentTrainerMons_Lesley
    },
    [VERDANTURF_TENT_TRAINER_MARQUIS] = {
        .facilityClass = FACILITY_CLASS_SAILOR,
        .trainerName = _("MARQUIS"),
        .speechBefore = COMPOUND_STRING("None of this is making sense."),
        .speechWin = COMPOUND_STRING("See? This just isn't normal."),
        .speechLose = COMPOUND_STRING("Should I cause an uproar?"),
        .monSet = gVerdanturfBattleTentTrainerMons_Marquis
    },
    [VERDANTURF_TENT_TRAINER_FREDDY] = {
        .facilityClass = FACILITY_CLASS_COLLECTOR,
        .trainerName = _("FREDDY"),
        .speechBefore = COMPOUND_STRING("I adore this cute television idol."),
        .speechWin = COMPOUND_STRING("You're so funny when you're angry."),
        .speechLose = COMPOUND_STRING("Late night television is my life."),
        .monSet = gVerdanturfBattleTentTrainerMons_Freddy
    },
    [VERDANTURF_TENT_TRAINER_CECILIA] = {
        .facilityClass = FACILITY_CLASS_LASS,
        .trainerName = _("CECILIA"),
        .speechBefore = COMPOUND_STRING("My fabulous cuteness is in fashion."),
        .speechWin = COMPOUND_STRING("You're no match for my cute charm."),
        .speechLose = COMPOUND_STRING("Don't you have fashion sense?"),
...
const struct BattleFrontierTrainer gFallarborBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    [FALLARBOR_TENT_TRAINER_AMBER] = {
        .facilityClass = FACILITY_CLASS_AROMA_LADY,
        .trainerName = _("AMBER"),
        .speechBefore = COMPOUND_STRING("I have to diet every day."),
        .speechWin = COMPOUND_STRING("A nightmare of sweets shocked me."),
        .speechLose = COMPOUND_STRING("If you give up you will lose."),
        .monSet = gFallarborBattleTentTrainerMons_Amber
    },
    [FALLARBOR_TENT_TRAINER_JAVIER] = {
        .facilityClass = FACILITY_CLASS_RUIN_MANIAC,
        .trainerName = _("JAVIER"),
        .speechBefore = COMPOUND_STRING("I never ever have enough money."),
        .speechWin = COMPOUND_STRING("I won but I need money."),
        .speechLose = COMPOUND_STRING("I need money for a bike."),
        .monSet = gFallarborBattleTentTrainerMons_Javier
    },
    [FALLARBOR_TENT_TRAINER_NATALIA] = {
        .facilityClass = FACILITY_CLASS_TUBER_F,
        .trainerName = _("NATALIE"),
        .speechBefore = COMPOUND_STRING("The way I battle is weird."),
        .speechWin = COMPOUND_STRING("You're much too weak for this place."),
        .speechLose = COMPOUND_STRING("Give me an easy match next time."),
        .monSet = gFallarborBattleTentTrainerMons_Natalie
    },
    [FALLARBOR_TENT_TRAINER_TREVE] = {
        .facilityClass = FACILITY_CLASS_TUBER_M,
        .trainerName = _("TREVE"),
        .speechBefore = COMPOUND_STRING("Look at my metronome and sleep."),
        .speechWin = COMPOUND_STRING("Yeah! Hypnosis is totally great."),
        .speechLose = COMPOUND_STRING("My hypnosis didn't work… -1."),
        .monSet = gFallarborBattleTentTrainerMons_Treve
    },
    [FALLARBOR_TENT_TRAINER_ARIANNA] = {
        .facilityClass = FACILITY_CLASS_LADY,
        .trainerName = _("ARIANNA"),
        .speechBefore = COMPOUND_STRING("If I win give me Pokémon for my collection."),
        .speechWin = COMPOUND_STRING("Your Pokémon are too weak to collect."),
    ...
    [FALLARBOR_TENT_TRAINER_JADYN] = {
        .facilityClass = FACILITY_CLASS_BEAUTY,
        .trainerName = _("JADYN"),
        .speechBefore = COMPOUND_STRING("My name is really a mystery."),
        .speechWin = COMPOUND_STRING("My name goes on a mystery."),
        .speechLose = COMPOUND_STRING("My name? I am your mother."),
        .monSet = gFallarborBattleTentTrainerMons_Jadyn
    },
    [FALLARBOR_TENT_TRAINER_GERARDO] = {
        .facilityClass = FACILITY_CLASS_RICH_BOY,
        .trainerName = _("GERARDO"),
        .speechBefore = COMPOUND_STRING("I am the best hero ever!"),
        .speechWin = COMPOUND_STRING("See what I mean? -1."),
        .speechLose = COMPOUND_STRING("Huh ques you were right? -1."),
        .monSet = gFallarborBattleTentTrainerMons_Gerardo
    },
    [FALLARBOR_TENT_TRAINER_JONN] = {
        .facilityClass = FACILITY_CLASS_POKEMANIAC,
        .trainerName = _("JONN"),
        .speechBefore = COMPOUND_STRING("The world superpower stomp contest!!"),
        .speechWin = COMPOUND_STRING("I am no 1!! Hear me roar."),
        .speechLose = COMPOUND_STRING("I give up! You're no 1!"),
        .monSet = gFallarborBattleTentTrainerMons_Jonn
    },
    [FALLARBOR_TENT_TRAINER_ESTEBAN] = {
        .facilityClass = FACILITY_CLASS_SWIMMER_M,
        .trainerName = _("ESTEBAN"),
        .speechBefore = COMPOUND_STRING("You're a good trainer? Unbelievable."),
        .speechWin = COMPOUND_STRING("You're some pushover of a trainer."),
        .speechLose = COMPOUND_STRING("You're much too much for me."),
        .monSet = gFallarborBattleTentTrainerMons_Esteban
    },
    [FALLARBOR_TENT_TRAINER_JAMESON] = {
        .facilityClass = FACILITY_CLASS_CAMPER,
        .trainerName = _("JAMESON"),
        .speechBefore = COMPOUND_STRING("My Pokémon are silky smooth!"),
        .speechWin = COMPOUND_STRING("My silky smooth Pokémon rule!"),
        .speechLose = COMPOUND_STRING("My Pokémon struggle in your sticky hold."),
        .monSet = gFallarborBattleTentTrainerMons_Jameson
    },
    [FALLARBOR_TENT_TRAINER_ALANZO] = {
        .facilityClass = FACILITY_CLASS_BUG_MANIAC,
        .trainerName = _("ALANZO"),
        .speechBefore = COMPOUND_STRING("Foresight is a power I have."),
        .speechWin = COMPOUND_STRING("You're oblivious about foresight! -1."),
        .speechLose = COMPOUND_STRING("My foresight is always right!"),
        .monSet = gFallarborBattleTentTrainerMons_Alanzo
    },
    [FALLARBOR_TENT_TRAINER_HOWARD] = {
        .facilityClass = FACILITY_CLASS_GENTLEMAN,
        .trainerName = _("HOWARD"),
        .speechBefore = COMPOUND_STRING("Your Pokémon can't beat me -1."),
        .speechWin = COMPOUND_STRING("You couldn't win could you?"),
        .speechLose = COMPOUND_STRING("You would go all out…"),
        .monSet = gFallarborBattleTentTrainerMons_Howard
    },
    [FALLARBOR_TENT_TRAINER_CONRAD] = {
        .facilityClass = FACILITY_CLASS_GUITARIST,
        .trainerName = _("CONRAD"),
        .speechBefore = COMPOUND_STRING("Your Pokémon are pretty wild!"),
        .speechWin = COMPOUND_STRING("Whoah!! -1 let's dance!"),
        .speechLose = COMPOUND_STRING("My music will play on…"),
        .monSet = gFallarborBattleTentTrainerMons_Conrad
    },
    [FALLARBOR_TENT_TRAINER_MAKENNA] = {
        .facilityClass = FACILITY_CLASS_SCHOOL_KID_F,
        .trainerName = _("MAKENNA"),
        .speechBefore = COMPOUND_STRING("Show me that you mean it."),
        .speechWin = COMPOUND_STRING("That's why I study every day."),
        .speechLose = COMPOUND_STRING("Aww I study every day too."),
        .monSet = gFallarborBattleTentTrainerMons_Makenna
    },
    [FALLARBOR_TENT_TRAINER_BRAYAN] = {
        .facilityClass = FACILITY_CLASS_COOLTRAINER_M,
        .trainerName = _("BRAYAN"),
        .speechBefore = COMPOUND_STRING("Can you see my power?"),
        .speechWin = COMPOUND_STRING("How boring… This is good bye."),
        .speechLose = COMPOUND_STRING("Am I the weak trainer?"),
        .monSet = gFallarborBattleTentTrainerMons_Brayan
    },
    [FALLARBOR_TENT_TRAINER_MARIANA] = {
        .facilityClass = FACILITY_CLASS_COOLTRAINER_F,
        .trainerName = _("MARIANA"),
        .speechBefore = COMPOUND_STRING("A lie can be kind…"),
        .speechWin = COMPOUND_STRING("This is like the sunday comics."),
        .speechLose = COMPOUND_STRING("This is like from a movie."),
        .monSet = gFallarborBattleTentTrainerMons_Mariana
    },
    [FALLARBOR_TENT_TRAINER_SHELDON] = {
        .facilityClass = FACILITY_CLASS_POKEFAN_M,
        .trainerName = _("SHELDON"),
        .speechBefore = COMPOUND_STRING("A Pokémon teacher gets no rest."),
        .speechWin = COMPOUND_STRING("My smartness gets me easy wins."),
        .speechLose = COMPOUND_STRING("I have to go work bye bye."),
        .monSet = gFallarborBattleTentTrainerMons_Sheldon
    },
    [FALLARBOR_TENT_TRAINER_GIANNA] = {
        .facilityClass = FACILITY_CLASS_POKEFAN_F,
        .trainerName = _("GIANNA"),
        .speechBefore = COMPOUND_STRING("Ahaha yes! Lovey dovey Pokémon world."),
        .speechWin = COMPOUND_STRING("My shine is making things better."),
        .speechLose = COMPOUND_STRING("Do you dislike Pokémon? -1."),
        .monSet = gFallarborBattleTentTrainerMons_Gianna
    },
    [FALLARBOR_TENT_TRAINER_YAHIR] = {
        .facilityClass = FACILITY_CLASS_EXPERT_M,
        .trainerName = _("YAHIR"),
        .speechBefore = COMPOUND_STRING("You……………………… Come on!"),
        .speechWin = COMPOUND_STRING("You need to train a lot more."),
        .speechLose = COMPOUND_STRING("Not enough… Just not enough."),
        .monSet = gFallarborBattleTentTrainerMons_Yahir
    },
    [FALLARBOR_TENT_TRAINER_BRITNEY] = {
        .facilityClass = FACILITY_CLASS_EXPERT_F,
        .trainerName = _("BRITNEY"),
        .speechBefore = COMPOUND_STRING("It seems that you're quite good."),
        .speechWin = COMPOUND_STRING("You're a lukewarm talent at best."),
        .speechLose = COMPOUND_STRING("You're a cool hero at this."),
        .monSet = gFallarborBattleTentTrainerMons_Britney
    },
    [FALLARBOR_TENT_TRAINER_HECTER] = {
        .facilityClass = FACILITY_CLASS_YOUNGSTER,
        .trainerName = _("HECTER"),
        .speechBefore = COMPOUND_STRING("My hidden power is exciting me!"),
        .speechWin = COMPOUND_STRING("Yeehaw excl let's have a hidden power party."),
        .speechLose = COMPOUND_STRING("Waaah! Don't you mimic me."),
        .monSet = gFallarborBattleTentTrainerMons_Hecter
    },
    [FALLARBOR_TENT_TRAINER_TANNOR] = {
        .facilityClass = FACILITY_CLASS_FISHERMAN,
        .trainerName = _("TANNOR"),
        .speechBefore = COMPOUND_STRING("You have got to be joking."),
        .speechWin = COMPOUND_STRING("You're the best at being funny."),
        .speechLose = COMPOUND_STRING("You weren't being funny at all."),
        .monSet = gFallarborBattleTentTrainerMons_Tannor
    },
    [FALLARBOR_TENT_TRAINER_BENJI] = {
        .facilityClass = FACILITY_CLASS_BIRD_KEEPER,
        .trainerName = _("BENJI"),
        .speechBefore = COMPOUND_STRING("You don't think very fast huh ques."),
        .speechWin = COMPOUND_STRING("Sorry! I didn't mean you."),
        .speechLose = COMPOUND_STRING("You left me feeling sad…"),
        .monSet = gFallarborBattleTentTrainerMons_Benji
    },
    [FALLARBOR_TENT_TRAINER_RORY] = {
        .facilityClass = FACILITY_CLASS_NINJA_BOY,
        .trainerName = _("RORY"),
        .speechBefore = COMPOUND_STRING("Don't cause an uproar you!"),
        .speechWin = COMPOUND_STRING("I don't need an uproar!"),
        .speechLose = COMPOUND_STRING("I am going to cause an uproar."),
        .monSet = gFallarborBattleTentTrainerMons_Rory
    },
    [FALLARBOR_TENT_TRAINER_ELEANOR] = {
        .facilityClass = FACILITY_CLASS_PARASOL_LADY,
        .trainerName = _("ELEANOR"),
        .speechBefore = COMPOUND_STRING("I really want to party -1."),
        .speechWin = COMPOUND_STRING("A trendy party would be refreshing."),
        .speechLose = COMPOUND_STRING("Don't you like to party?"),
        .monSet = gFallarborBattleTentTrainerMons_Eleanor
    },
    [FALLARBOR_TENT_TRAINER_EVELYN] = {
        .facilityClass = FACILITY_CLASS_SWIMMER_F,
        .trainerName = _("EVELYN"),
        .speechBefore = COMPOUND_STRING("My pc is my secret base!"),
        .speechWin = COMPOUND_STRING("It's all secret on my pc."),
        .speechLose = COMPOUND_STRING("No! -1 I reject this."),
        .monSet = gFallarborBattleTentTrainerMons_Evelyn
    },
    [FALLARBOR_TENT_TRAINER_ARIELLE] = {
        .facilityClass = FACILITY_CLASS_PICNICKER,
        .trainerName = _("ARIELLE"),
        .speechBefore = COMPOUND_STRING("It's not very pretty but I try."),
        .speechWin = COMPOUND_STRING("We're not very pretty but we're great."),
        .speechLose = COMPOUND_STRING("That was pretty mean of you!"),
        .monSet = gFallarborBattleTentTrainerMons_Arielle
    },
    [FALLARBOR_TENT_TRAINER_CONNAR] = {
        .facilityClass = FACILITY_CLASS_SAILOR,
        .trainerName = _("CONNAR"),
        .speechBefore = COMPOUND_STRING("I am not strong enough for this."),
        .speechWin = COMPOUND_STRING("Do you think you're ok ques -1."),
        .speechLose = COMPOUND_STRING("Good bye and thank you -1 -1 -1."),
        .monSet = gFallarborBattleTentTrainerMons_Connar
    },
    [FALLARBOR_TENT_TRAINER_MAURICE] = {
        .facilityClass = FACILITY_CLASS_COLLECTOR,
        .trainerName = _("MAURICE"),
        .speechBefore = COMPOUND_STRING("There is no radio or television."),
        .speechWin = COMPOUND_STRING("But there is a lot of Pokémon."),
        .speechLose = COMPOUND_STRING("I can't enjoy myself without money."),
        .monSet = gFallarborBattleTentTrainerMons_Maurice
    },
    [FALLARBOR_TENT_TRAINER_KIANNA] = {
        .facilityClass = FACILITY_CLASS_LASS,
        .trainerName = _("KIANNA"),
        .speechBefore = COMPOUND_STRING("I want to go dept store shopping."),
        .speechWin = COMPOUND_STRING("I dislike shopping alone -1 -1."),
        .speechLose = COMPOUND_STRING("Want to go shopping together?"),
