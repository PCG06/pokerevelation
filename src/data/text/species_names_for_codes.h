...
const u8 gSpeciesNamesForCodes[][CODE_NAME_LENGTH + 1] = {
    ...
    [SPECIES_BURMY_PLANT] = _("Burmy"),
    [SPECIES_WORMADAM_PLANT] = _("Wormadam"),
    ...
    [SPECIES_DARMANITAN_STANDARD] = _("Darmanitan"),
    ...
    [SPECIES_FLABEBE_RED] = _("Flabebe"),
    [SPECIES_FLOETTE_RED] = _("Floette"),
    [SPECIES_FLORGES_RED] = _("Florges"),
    ...
    [SPECIES_POLTEAGEIST_PHONY] = _("Polteageist"),
    ...
    [SPECIES_EISCUE_ICE] = _("Eiscue"),
    [SPECIES_INDEEDEE_M] = _("Indeedee"),
    ...
    [SPECIES_ZACIAN_HERO] = _("Zacian"),
    [SPECIES_ZAMAZENTA_HERO] = _("Zamazenta"),
    [SPECIES_ETERNATUS] = _("Eternatus"),
    [SPECIES_KUBFU] = _("Kubfu"),
    [SPECIES_URSHIFU_SINGLE_STRIKE] = _("Urshifu"),
    ...
    [SPECIES_BASCULEGION_M] = _("Basculegion"),
    ...
    [SPECIES_OINKOLOGNE_M] = _("Oinkologne"),
    ...
    [SPECIES_MAUSHOLD_FOUR] = _("Maushold"),
    ...
    [SPECIES_SQUAWKABILLY_GREEN] = _("Squawkabilly"),
    ...
    [SPECIES_DUDUNSPARCE_TWO_SEGMENT] = _("Dudunsparce"),
    [SPECIES_KINGAMBIT] = _("Kingambit"),
    [SPECIES_GREAT_TUSK] = _("Great Tusk"),
    [SPECIES_SCREAM_TAIL] = _("Scream Tail"),
    [SPECIES_BRUTE_BONNET] = _("Brute Bonnet"),
    [SPECIES_FLUTTER_MANE] = _("Flutter Mane"),
    [SPECIES_SLITHER_WING] = _("Slither Wing"),
    [SPECIES_SANDY_SHOCKS] = _("Sandy Shocks"),
    [SPECIES_IRON_TREADS] = _("Iron Treads"),
    [SPECIES_IRON_BUNDLE] = _("Iron Bundle"),
    [SPECIES_IRON_HANDS] = _("Iron Hands"),
    [SPECIES_IRON_JUGULIS] = _("Iron Jugulis"),
    [SPECIES_IRON_MOTH] = _("Iron Moth"),
    [SPECIES_IRON_THORNS] = _("Iron Thorns"),
    ...
    [SPECIES_ROARING_MOON] = _("Roaring Moon"),
    [SPECIES_IRON_VALIANT] = _("Iron Valiant"),
    [SPECIES_KORAIDON] = _("Koraidon"),
    [SPECIES_MIRAIDON] = _("Miraidon"),
    [SPECIES_WALKING_WAKE] = _("Walking Wake"),
    [SPECIES_IRON_LEAVES] = _("Iron Leaves"),
    [SPECIES_URSALUNA_BLOODMOON] = _("UrsalunaB"),
    [SPECIES_DIPPLIN] = _("Dipplin"),
    [SPECIES_POLTCHAGEIST_COUNTERFEIT] = _("Poltchageist"),
    ...
    [SPECIES_RAGING_BOLT] = _("Raging Bolt"),
    ...
    // ALOLA Forms
    [SPECIES_RATTATA_ALOLA] = _("Rattata-A"),
    [SPECIES_RATICATE_ALOLA] = _("Raticate-A"),
    [SPECIES_RAICHU_ALOLA] = _("Raichu-A"),
    [SPECIES_SANDSHREW_ALOLA] = _("Sandshrew-A"),
    [SPECIES_SANDSLASH_ALOLA] = _("Sandslash-A"),
    [SPECIES_VULPIX_ALOLA] = _("Vulpix-A"),
    [SPECIES_NINETALES_ALOLA] = _("Ninetales-A"),
    [SPECIES_DIGLETT_ALOLA] = _("Diglett-A"),
    [SPECIES_DUGTRIO_ALOLA] = _("Dugtrio-A"),
    [SPECIES_MEOWTH_ALOLA] = _("Meowth-A"),
    [SPECIES_PERSIAN_ALOLA] = _("Persian-A"),
    [SPECIES_GEODUDE_ALOLA] = _("Geodude-A"),
    [SPECIES_GRAVELER_ALOLA] = _("Graveler-A"),
    [SPECIES_GOLEM_ALOLA] = _("Golem-A"),
    [SPECIES_GRIMER_ALOLA] = _("Grimer-A"),
    [SPECIES_MUK_ALOLA] = _("Muk-A"),
    [SPECIES_EXEGGUTOR_ALOLA] = _("Exeggutor-A"),
    [SPECIES_MAROWAK_ALOLA] = _("Marowak-A"),

    // GALAR Forms
    [SPECIES_MEOWTH_GALAR] = _("Meowth-G"),
    [SPECIES_PONYTA_GALAR] = _("Ponyta-G"),
    [SPECIES_RAPIDASH_GALAR] = _("Rapidash-G"),
    [SPECIES_SLOWPOKE_GALAR] = _("Slowpoke-G"),
    [SPECIES_SLOWBRO_GALAR] = _("Slowbro-G"),
    [SPECIES_FARFETCHD_GALAR] = _("Farfetch'd-G"),
    [SPECIES_WEEZING_GALAR] = _("Weezing-G"),
    [SPECIES_MR_MIME_GALAR] = _("Mr. Mime-G"),
    [SPECIES_ARTICUNO_GALAR] = _("Articuno-G"),
    [SPECIES_ZAPDOS_GALAR] = _("Zapdos-G"),
    [SPECIES_MOLTRES_GALAR] = _("Moltres-G"),
    [SPECIES_SLOWKING_GALAR] = _("Slowking-G"),
    [SPECIES_CORSOLA_GALAR] = _("Corsola-G"),
    [SPECIES_ZIGZAGOON_GALAR] = _("Zigzagoon-G"),
    [SPECIES_LINOONE_GALAR] = _("Linoone-G"),
#if P_GEN_5_POKEMON == TRUE
    [SPECIES_DARUMAKA_GALAR] = _("Darumaka-G"),
    [SPECIES_DARMANITAN_GALAR_STANDARD] = _("Darmanitan-G"),
    [SPECIES_YAMASK_GALAR] = _("Yamask-G"),
    [SPECIES_STUNFISK_GALAR] = _("Stunfisk-G"),
#endif

//HISUI Forms
    [SPECIES_GROWLITHE_HISUI] = _("Growlithe-H"),
    [SPECIES_ARCANINE_HISUI] = _("Arcanine-H"),
    [SPECIES_VOLTORB_HISUI] = _("Voltorb-H"),
    [SPECIES_ELECTRODE_HISUI] = _("Electrode-H"),
    [SPECIES_TYPHLOSION_HISUI] = _("Typhlosion-H"),
    [SPECIES_QWILFISH_HISUI] = _("Qwilfish-H"),
    [SPECIES_SNEASEL_HISUI] = _("Sneasel-H"),
#if P_GEN_5_POKEMON == TRUE
    [SPECIES_SAMUROTT_HISUI] = _("Samurott-H"),
    [SPECIES_LILLIGANT_HISUI] = _("Lilligant-H"),
    [SPECIES_ZORUA_HISUI] = _("Zorua-H"),
    [SPECIES_ZOROARK_HISUI] = _("Zoroar-Hk"),
    [SPECIES_BRAVIARY_HISUI] = _("Braviary-H"),
#endif
#if P_GEN_6_POKEMON == TRUE
    [SPECIES_SLIGGOO_HISUI] = _("Sliggoo-H"),
    [SPECIES_GOODRA_HISUI] = _("Goodra-H"),
    [SPECIES_AVALUGG_HISUI] = _("Avalugg-H"),
#endif
#if P_GEN_7_POKEMON == TRUE
    [SPECIES_DECIDUEYE_HISUI] = _("Decidueye-H"),
#endif
    [SPECIES_WOOPER_PALDEA] = _("Wooper-P"),
    [SPECIES_TAUROS_PALDEA_COMBAT] = _("Tauros-P"),

    // Cosplay Pikachu
    [SPECIES_PIKACHU_COSPLAY] = _("PikachuC"),
    [SPECIES_PIKACHU_ROCK_STAR] = _("PikachuR"),
    [SPECIES_PIKACHU_BELLE] = _("PikachuB"),
    [SPECIES_PIKACHU_POP_STAR] = _("PikachuP"),
    [SPECIES_PIKACHU_PHD] = _("PikachuPh"),
    [SPECIES_PIKACHU_LIBRE] = _("PikachuL"),
    // Cap Pikachu
    [SPECIES_PIKACHU_ORIGINAL] = _("Pikachu"),
    [SPECIES_PIKACHU_HOENN] = _("Pikachu"),
    [SPECIES_PIKACHU_SINNOH] = _("Pikachu"),
    [SPECIES_PIKACHU_UNOVA] = _("Pikachu"),
    [SPECIES_PIKACHU_KALOS] = _("Pikachu"),
    [SPECIES_PIKACHU_ALOLA] = _("Pikachu"),
    [SPECIES_PIKACHU_PARTNER] = _("Pikachu"),
    [SPECIES_PIKACHU_WORLD] = _("Pikachu"),
    // Unown
    [SPECIES_UNOWN_B] = _("UnownB"),
    [SPECIES_UNOWN_C] = _("UnownC"),
    [SPECIES_UNOWN_D] = _("UnownD"),
    [SPECIES_UNOWN_E] = _("UnownE"),
    [SPECIES_UNOWN_F] = _("UnownF"),
    [SPECIES_UNOWN_G] = _("UnownG"),
    [SPECIES_UNOWN_H] = _("UnownH"),
    [SPECIES_UNOWN_I] = _("UnownI"),
    [SPECIES_UNOWN_J] = _("UnownJ"),
    [SPECIES_UNOWN_K] = _("UnownK"),
    [SPECIES_UNOWN_L] = _("UnownL"),
    [SPECIES_UNOWN_M] = _("UnownM"),
    [SPECIES_UNOWN_N] = _("UnownN"),
    [SPECIES_UNOWN_O] = _("UnownO"),
    [SPECIES_UNOWN_P] = _("UnownP"),
    [SPECIES_UNOWN_Q] = _("UnownQ"),
    [SPECIES_UNOWN_R] = _("UnownR"),
    [SPECIES_UNOWN_S] = _("UnownS"),
    [SPECIES_UNOWN_T] = _("UnownT"),
    [SPECIES_UNOWN_U] = _("UnownU"),
    [SPECIES_UNOWN_V] = _("UnownV"),
    [SPECIES_UNOWN_W] = _("UnownW"),
    [SPECIES_UNOWN_X] = _("UnownX"),
    [SPECIES_UNOWN_Y] = _("UnownY"),
    [SPECIES_UNOWN_Z] = _("UnownZ"),
    [SPECIES_UNOWN_EXCLAMATION] = _("Unown"),
    [SPECIES_UNOWN_QUESTION] = _("Unown"),
    // Deoxys
    [SPECIES_DEOXYS_ATTACK] = _("DeoxysA"),
    [SPECIES_DEOXYS_DEFENSE] = _("DeoxysD"),
    [SPECIES_DEOXYS_SPEED] = _("DeoxysS"),
#if P_GEN_4_POKEMON == TRUE
    // Burmy
    [SPECIES_BURMY_SANDY] = _("BurmyS"),
    [SPECIES_BURMY_TRASH] = _("BurmyT"),
    // Wormadam
    [SPECIES_WORMADAM_SANDY] = _("WormadamS"),
    [SPECIES_WORMADAM_TRASH] = _("WormadamT"),
    // Shellos
    [SPECIES_SHELLOS_EAST] = _("ShellosE"),
    // Gastrodon
    [SPECIES_GASTRODON_EAST] = _("GastrodonE"),
    // Rotom
    [SPECIES_ROTOM_HEAT] = _("RotomH"),
    [SPECIES_ROTOM_FAN] = _("RotomF"),
    ...
    // Darmanitan
    // Deerling
    [SPECIES_DEERLING_SUMMER] = _("DeerlingS"),
    [SPECIES_DEERLING_AUTUMN] = _("DeerlingA"),
    [SPECIES_DEERLING_WINTER] = _("DeerlingW"),
    // Sawsbuck
    [SPECIES_SAWSBUCK_SUMMER] = _("SawsbuckS"),
    [SPECIES_SAWSBUCK_AUTUMN] = _("SawsbuckA"),
    [SPECIES_SAWSBUCK_WINTER] = _("SawsbuckW"),
    // Therians
    [SPECIES_TORNADUS_THERIAN] = _("TornadusT"),
    [SPECIES_THUNDURUS_THERIAN] = _("ThundurusT"),
    [SPECIES_LANDORUS_THERIAN] = _("LandorusT"),
    [SPECIES_ENAMORUS_THERIAN] = _("EnamorusT"),
    // Kyurem
    [SPECIES_KYUREM_BLACK] = _("KyuremB"),
    [SPECIES_KYUREM_WHITE] = _("KyuremW"),
#endif
#if P_GEN_6_POKEMON == TRUE
    // Greninja
    [SPECIES_GRENINJA_BATTLE_BOND] = _("GreninjaB"),
    // Vivillon
    ...
    [SPECIES_VIVILLON_POKEBALL] = _("Vivillon"),
    // Flabebe
    [SPECIES_FLABEBE_YELLOW] = _("FlabebeY"),
    [SPECIES_FLABEBE_ORANGE] = _("FlabebeO"),
    [SPECIES_FLABEBE_BLUE] = _("FlabebeB"),
    [SPECIES_FLABEBE_WHITE] = _("FlabebeW"),
    // Floette
    [SPECIES_FLOETTE_YELLOW] = _("FloetteY"),
    [SPECIES_FLOETTE_ORANGE] = _("FloetteO"),
    [SPECIES_FLOETTE_BLUE] = _("FloetteB"),
    [SPECIES_FLOETTE_WHITE] = _("FloetteW"),
    [SPECIES_FLOETTE_ETERNAL] = _("FloetteE"),
    // Florges
    [SPECIES_FLORGES_YELLOW] = _("FlorgesY"),
    [SPECIES_FLORGES_ORANGE] = _("FlorgesO"),
    [SPECIES_FLORGES_BLUE] = _("FlorgesB"),
    [SPECIES_FLORGES_WHITE] = _("FlorgesW"),
    // Furfrou
...
#if P_GEN_7_POKEMON == TRUE
    // Oricorio
    [SPECIES_ORICORIO_POM_POM] = _("OricorioPP"),
    [SPECIES_ORICORIO_PAU] = _("OricorioP"),
    [SPECIES_ORICORIO_SENSU] = _("OricorioS"),
    // Lycanroc
    [SPECIES_LYCANROC_MIDNIGHT] = _("LycanrocM"),
    [SPECIES_LYCANROC_DUSK] = _("LycanrocD"),
    // Minior
    [SPECIES_MINIOR_METEOR_ORANGE] = _("MiniorO"),
    [SPECIES_MINIOR_METEOR_YELLOW] = _("MiniorY"),
    [SPECIES_MINIOR_METEOR_GREEN] = _("MiniorG"),
    [SPECIES_MINIOR_METEOR_BLUE] = _("MiniorB"),
    [SPECIES_MINIOR_METEOR_INDIGO] = _("MiniorI"),
    [SPECIES_MINIOR_METEOR_VIOLET] = _("MiniorV"),
    // Necrozma
    [SPECIES_NECROZMA_DUSK_MANE] = _("NecrozmaDM"),
    [SPECIES_NECROZMA_DAWN_WINGS] = _("NecrozmaDW"),
    // Magearna
    [SPECIES_MAGEARNA_ORIGINAL] = _("MagearnaO"),
#endif
#if P_GEN_8_POKEMON == TRUE
    // Toxtricity
    [SPECIES_TOXTRICITY_LOW_KEY] = _("ToxtricityL"),
    // Indeedee
    [SPECIES_INDEEDEE_F] = _("IndeedeeF"),
    // Urshifu
    [SPECIES_URSHIFU_RAPID_STRIKE] = _("UrshifuR"),
    // Zarude
    [SPECIES_ZARUDE_DADA] = _("ZarudeD"),
    // Calyrex
    [SPECIES_CALYREX_ICE] = _("CalyrexI"),
    [SPECIES_CALYREX_SHADOW] = _("CalyrexS"),
    // Basculegion
    [SPECIES_BASCULEGION_F] = _("BasculegionF"),
#endif
#if P_GEN_9_POKEMON == TRUE
    // Oinkologne
    [SPECIES_OINKOLOGNE_F] = _("OinkologneF"),
    // Maushold
    [SPECIES_MAUSHOLD_THREE] = _("Maushold3"),
    // Squawkabilly
    [SPECIES_SQUAWKABILLY_BLUE] = _("SquawkabillyB"),
    [SPECIES_SQUAWKABILLY_YELLOW] = _("SquawkabillyY"),
    [SPECIES_SQUAWKABILLY_WHITE] = _("SquawkabillyW"),
    // Tatsugiri
    [SPECIES_TATSUGIRI_DROOPY] = _("TatsugiriD"),
    [SPECIES_TATSUGIRI_STRETCHY] = _("TatsugiriS"),
    // Dudunsparce
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] = _("Dudunsparce3"),
    // Gimmighoul
    [SPECIES_GIMMIGHOUL_ROAMING] = _("GimmighoulR"),
#endif
    // Tauros-Paldea
    [SPECIES_TAUROS_PALDEA_BLAZE] = _("Tauros-PB"),
    [SPECIES_TAUROS_PALDEA_AQUA] = _("Tauros-PA"),
};
