...
static const struct LevelUpMove sStratospiraLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_JETSTREAM_BLAST),
    LEVEL_UP_MOVE( 0, MOVE_FLASH_CANNON),
    LEVEL_UP_MOVE( 0, MOVE_KNOCK_OFF),
...
static const struct LevelUpMove sPhantomarLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SPECTRAL_WRATH),
    LEVEL_UP_MOVE( 0, MOVE_EARTHQUAKE),
    LEVEL_UP_MOVE( 0, MOVE_KNOCK_OFF),
    LEVEL_UP_MOVE( 0, MOVE_U_TURN),
    LEVEL_UP_END
...
static const struct LevelUpMove sLeviadonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_DRACONIC_FURY),
...
static const struct LevelUpMove sZojzionLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_LIGHTNING_VORTEX),
...
static const struct LevelUpMove sMantistrikeLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_SMASH_STRIKE),
...
static const struct LevelUpMove sPyrolinLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_DRILL_OUT),
    LEVEL_UP_MOVE( 0, MOVE_FIRE_LASH),
    LEVEL_UP_MOVE( 0, MOVE_KNOCK_OFF),
...
static const struct LevelUpMove sAmanisteLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 0, MOVE_MYCO_SHIFT),
