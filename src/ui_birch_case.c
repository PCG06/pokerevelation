...
static const struct MonChoiceData sStarterChoices[9] = 
{
    ...
    [BALL_TOP_FOURTH]       = {SPECIES_CYNDAQUIL, 5},
    [BALL_MIDDLE_THIRD]     = {SPECIES_TOTODILE, 5},
...
static const u32 sTextBgTiles[]   = INCBIN_U32("graphics/ui_birch_case/text_bg_tiles.4bpp.smolTM");
...
void BirchCase_GiveMon(void) // Function that calls the GiveMon function pulled from Expansion by Lunos and Ghoulslash
{
