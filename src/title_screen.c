...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/computer.4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/computer.bin.smolTM");
...
static void UNUSED UpdateLegendaryMarkingColor(u8 frameNum)
{
