...
const u8 gText_OpenLevel[] = _("LV. 100");
...
const u8 gText_Battles[] = _("BATTLES");
const u8 gText_WinRate[] = _("WIN RATE");
const u8 gText_BattleTowerStreak[] = _("BTL TWR STREAK (LV)");
const u8 gText_Lv50Lv100[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}50:{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}  100:{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_2}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}");
...
const u8 gText_PlayerLostChallenge[] = _("{PLAYER} has lost the\nRevelation Challenge!\n\nYour progress will be saved and\nyou will be taken back the Lobby…\p");
const u8 gText_PlayerForfeitedChallenge[] = _("{PLAYER} has forfeited the\nRevelation Challenge!\n\nYour progress will be saved and\nyou will be taken back the Lobby…\p");
...
const u8 gText_OpenLv[] = _("LV. 100");
...
ALIGNED(4) const u8 gText_RecordsOpenLevel[] = _("LV. 100");
...
const u8 gText_Imperial[] = _("IMPERIAL");
const u8 gText_Metric[] = _("METRIC");
...
const u8 gText_BattleEnvironment[] = _("BATTLE ENV.");
const u8 gText_Grass[] = _("GRASS");
const u8 gText_LongGrass[] = _("LONG GRASS");
const u8 gText_Sand[] = _("SAND");
const u8 gText_Underwater[] = _("UNDERWATER");
const u8 gText_Water[] = _("WATER");
const u8 gText_Pond[] = _("POND");
const u8 gText_Mountain[] = _("MOUNTAIN");
const u8 gText_Cave[] = _("CAVE");
const u8 gText_Building[] = _("BUILDING");
const u8 gText_Plain[] = _("PLAIN");
const u8 gText_Snow[] = _("SNOW");
const u8 gText_IceBg[] = _("ICE");
...
const u8 gText_BattleMusic[] = _("BATTLE MUSIC");
const u8 gText_VSMusic[] = _("VS.");
const u8 gText_Default[] = _("DEFAULT");
const u8 gText_Random[] = _("RANDOM");
const u8 gText_Frontier[] = _("FRONTIER");
const u8 gText_Trainer[] = _("TRAINER");
const u8 gText_Rival[] = _("RIVAL");
const u8 gText_GymLeader[] = _("GYM LEADER");
const u8 gText_EliteFour[] = _("ELITE FOUR");
const u8 gText_Champion[] = _("CHAMPION");
const u8 gText_AquaMagma[] = _("AQUA/MAGMA");
const u8 gText_Wild[] = _("WILD");
...
const u8 gText_MenuStatEditor[] = _("STAT EDITOR");
...
const u8 gText_DexHoenn[] = _("REGION");
...
const u8 gText_SavingWinsLosses[] = _("WINS/LOSSES");
const u8 gText_SavingHallOfFames[] = _("HALL OF FAMES");
