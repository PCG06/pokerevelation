...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_QUESTIONFORFEITBATTLE]                = COMPOUND_STRING("Would you like to forfeit the battle? (Considered as a loss)"),
    ...
    [STRINGID_CLEAREDALLHAZARDS]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} cleared all the hazards on {B_ATK_TEAM2} team's side!"),
};
...
const u8 gText_BattleMenuNoBag[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Battle{CLEAR_TO 56}{COLOR 00}Bag\n{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Pokémon{CLEAR_TO 56}Run");
