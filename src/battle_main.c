...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_EXPERT] = { _("EXPERT"), 10, BALL_HEAVY },
    ...
    [TRAINER_CLASS_RUIN_MANIAC] = { _("RUIN MANIAC"), 15, BALL_HEAVY },
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVIEWER"), 12, BALL_POKE },
    [TRAINER_CLASS_TUBER_F] = { _("TUBER"), 1, BALL_POKE },
    [TRAINER_CLASS_TUBER_M] = { _("TUBER"), 1, BALL_POKE },
    [TRAINER_CLASS_LADY] = { _("LADY"), 50, BALL_LUXURY },
    [TRAINER_CLASS_BEAUTY] = { _("BEAUTY"), 20, BALL_LUXURY },
    ...
    [TRAINER_CLASS_KINDLER] = { _("KINDLER"), 8, BALL_HEAVY },
    [TRAINER_CLASS_CAMPER] = { _("CAMPER"), 4, BALL_NEST },
    [TRAINER_CLASS_PICNICKER] = { _("PICNICKER"), 4, BALL_NEST },
    [TRAINER_CLASS_BUG_MANIAC] = { _("BUG MANIAC"), 15, BALL_NEST },
    [TRAINER_CLASS_PSYCHIC] = { _("PSYCHIC"), 6, BALL_DREAM },
    ...
    [TRAINER_CLASS_SCHOOL_KID] = { _("SCHOOL KID"), 5, BALL_POKE },
    [TRAINER_CLASS_SR_AND_JR] = { _("SR. AND JR."), 4, BALL_LEVEL },
    [TRAINER_CLASS_WINSTRATE] = { _("WINSTRATE"), 10, BALL_GREAT },
    [TRAINER_CLASS_POKEFAN] = { _("POKéFAN"), 20, BALL_LUXURY },
    [TRAINER_CLASS_YOUNGSTER] = { _("YOUNGSTER"), 4, BALL_POKE },
    ...
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DRAGON TAMER"), 12, BALL_HEAVY },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA BOY"), 3, BALL_DUSK },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("BATTLE GIRL"), 6, BALL_LEVEL },
    [TRAINER_CLASS_PARASOL_LADY] = { _("PARASOL LADY"), 10 },
    [TRAINER_CLASS_SWIMMER_F] = { _("SWIMMER♀"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("TWINS"), 3, BALL_POKE },
    ...
    [TRAINER_CLASS_BUG_CATCHER] = { _("BUG CATCHER"), 4, BALL_NEST },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 12, BALL_QUICK },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("MAGMA LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("LASS"), 4, BALL_TIMER },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("YOUNG COUPLE"), 8, BALL_LOVE },
    [TRAINER_CLASS_OLD_COUPLE] = { _("OLD COUPLE"), 10, BALL_LOVE },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("SIS AND BRO"), 3, BALL_POKE },
    ...
    [TRAINER_CLASS_BURGLAR] = { _("BURGLAR"), 4, BALL_GREAT },
    [TRAINER_CLASS_SCIENTIST] = { _("SCIENTIST"), 10, BALL_ULTRA },
    [TRAINER_CLASS_SUPER_NERD] = { _("SUPER NERD"), 8, BALL_QUICK },
    [TRAINER_CLASS_GARDENER] = { _("GARDENER"), 5, BALL_NEST },
    [TRAINER_CLASS_PROFESSOR] = { _("{PKMN} PROFESSOR"), 30, BALL_LUXURY },
    [TRAINER_CLASS_CHALLENGER] = {_("CHALLENGER"), 30, BALL_ULTRA},
};
        ...
        case STATE_WAIT_ACTION_CHOSEN: // Try to perform an action.
            if (!IsBattleControllerActiveOrPendingSyncAnywhere(battler))
            {
                ...
                case B_ACTION_DEBUG:
                    ...
                    MarkBattlerForControllerExec(battler);
                    break;
                case B_ACTION_BATTLE_MENU:
                    BtlController_EmitBattleMenu(battler, B_COMM_TO_CONTROLLER);
                    MarkBattlerForControllerExec(battler);
                    break;
                }
