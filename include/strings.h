...
extern const u8 gText_MenuStatEditor[];
...
extern const u8 gText_BattleEnvironment[];
extern const u8 gText_Grass[] ;
extern const u8 gText_LongGrass[];
extern const u8 gText_Sand[];
extern const u8 gText_Underwater[];
extern const u8 gText_Water[];
extern const u8 gText_Pond[];
extern const u8 gText_Mountain[];
extern const u8 gText_Cave[];
extern const u8 gText_Building[];
extern const u8 gText_Plain[];
extern const u8 gText_Snow[];
extern const u8 gText_IceBg[];
...
extern const u8 gText_VSMusic[];
extern const u8 gText_Default[];
extern const u8 gText_Random[];
extern const u8 gText_Frontier[];
extern const u8 gText_Trainer[];
extern const u8 gText_Rival[];
extern const u8 gText_GymLeader[];
extern const u8 gText_EliteFour[];
extern const u8 gText_Champion[];
extern const u8 gText_AquaMagma[];
extern const u8 gText_Wild[];
...
extern const u8 gText_Type_Normal[];
extern const u8 gText_Type_Fighting[];
extern const u8 gText_Type_Flying[];
extern const u8 gText_Type_Poison[];
extern const u8 gText_Type_Ground[];
extern const u8 gText_Type_Rock[];
extern const u8 gText_Type_Bug[];
extern const u8 gText_Type_Ghost[];
extern const u8 gText_Type_Steel[];
extern const u8 gText_Type_Fire[];
extern const u8 gText_Type_Water[];
extern const u8 gText_Type_Grass[];
extern const u8 gText_Type_Electric[];
extern const u8 gText_Type_Psychic[];
extern const u8 gText_Type_Ice[];
extern const u8 gText_Type_Dragon[];
extern const u8 gText_Type_Dark[];
extern const u8 gText_Type_Fairy[];
