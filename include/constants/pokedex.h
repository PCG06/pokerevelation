...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_AMANISTE
...
enum RegionalDexOrder
{
    ...
    REGIONAL_DEX_COTTONEE,
    REGIONAL_DEX_WHIMSICOTT,
    ...
    REGIONAL_DEX_ZOJZION,
    REGIONAL_DEX_MANTISTRIKE,
    REGIONAL_DEX_PYROLIN,
    REGIONAL_DEX_STRATOSPIRA,
    REGIONAL_DEX_PHANTOMAR,
    REGIONAL_DEX_LEVIADON,
    REGIONAL_DEX_AMANISTE,
};

#define REGIONAL_DEX_COUNT (REGIONAL_DEX_AMANISTE + 1)
